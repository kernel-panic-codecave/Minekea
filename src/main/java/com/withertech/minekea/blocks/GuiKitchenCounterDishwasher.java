...
public class GuiKitchenCounterDishwasher extends GuiContainer
{
    public static final int WIDTH = 180;
    public static final int HEIGHT = 152;

    private static final ResourceLocation background = new ResourceLocation(Minekea.MODID, "textures/gui/kitchencounterdishwasher.png");
    private TileKitchenCounterDishwasher oven;
    
    public GuiKitchenCounterDishwasher(TileKitchenCounterDishwasher tileEntity, ContainerKitchenCounterDishwasher container) {
        super(container);
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        {
            int percentage = 100 - oven.getClientProgress() * 100 / TileKitchenCounterDishwasher.MAX_PROGRESS;
    ...
    private void drawEnergyBar(int energy) {
        ...
        int percentage = energy * 100 / TileKitchenCounterDishwasher.MAX_POWER;
