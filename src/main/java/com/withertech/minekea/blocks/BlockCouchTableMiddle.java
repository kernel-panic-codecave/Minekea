...
public class BlockCouchTableMiddle extends Block
{
	...
	private static final AxisAlignedBB SIDE_1 = new AxisAlignedBB((0 * 0.0625), (6 * 0.0625), (0 * 0.0625), (1 * 0.0625), (8 * 0.0625), (16 * 0.0625));
	private static final AxisAlignedBB SIDE_2 = new AxisAlignedBB((15 * 0.0625), (6 * 0.0625), (0 * 0.0625), (16 * 0.0625), (8 * 0.0625), (16 * 0.0625));
