...
public class BlockArmchairWhite extends Block 
{
	...
	public BlockArmchairWhite()
	{
		super(Material.CLOTH);
		setSoundType(SoundType.CLOTH);
		setHardness(0.8F);
		setUnlocalizedName(Minekea.MODID + ".blockarmchairwhite");
		setRegistryName("blockarmchairwhite");
