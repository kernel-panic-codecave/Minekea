...
public class BlockKitchenFridge extends Block implements ITileEntityProvider
{
	public static final PropertyDirection FACING = PropertyDirection.create("facing");
	
	public BlockKitchenFridge()
	{
		super(Material.ROCK);
		setSoundType(SoundType.STONE);
		setHardness(2.0F);
		setResistance(5.0F);
		setUnlocalizedName(Minekea.MODID + ".blockkitchenfridge");
		setRegistryName("blockkitchenfridge");
	...
	public void initModel()
	{
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileKitchenFridge.class, new AnimationTESR<>());
	}
