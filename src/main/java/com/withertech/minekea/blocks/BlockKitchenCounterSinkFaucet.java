...
public class BlockKitchenCounterSinkFaucet extends Block
{
	...
	public BlockKitchenCounterSinkFaucet()
	{
		super(Material.ROCK);
		setSoundType(SoundType.STONE);
		setHardness(2.0F);
		setResistance(5.0F);
		setUnlocalizedName(Minekea.MODID + ".blockkitchencountersinkfaucet");
		setRegistryName("blockkitchencountersinkfaucet");
