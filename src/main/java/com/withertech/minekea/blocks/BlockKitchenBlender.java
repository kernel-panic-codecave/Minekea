...
public class BlockKitchenBlender extends Block implements ITileEntityProvider
{
	...
	public BlockKitchenBlender()
	{
		super(Material.ROCK);
		setSoundType(SoundType.STONE);
		setHardness(2.0F);
		setResistance(5.0F);
		setUnlocalizedName(Minekea.MODID + ".blockkitchenblender");
		setRegistryName("blockkitchenblender");
	...
	public void initModel()
	{
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileKitchenBlender.class, new AnimationTESR<>());
	}
