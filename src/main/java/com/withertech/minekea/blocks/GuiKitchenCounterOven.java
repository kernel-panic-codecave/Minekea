...
public class GuiKitchenCounterOven extends GuiContainer
{
	public static final int WIDTH = 180;
	public static final int HEIGHT = 152;
	
	private static final ResourceLocation background = new ResourceLocation(Minekea.MODID, "textures/gui/kitchencounteroven.png");
	private TileKitchenCounterOven oven;
	
	public GuiKitchenCounterOven(TileKitchenCounterOven tileEntity, ContainerKitchenCounterOven container)
	{
		super(container);
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		{
			int percentage = 100 - oven.getClientProgress() * 100 / TileKitchenCounterOven.MAX_PROGRESS;
