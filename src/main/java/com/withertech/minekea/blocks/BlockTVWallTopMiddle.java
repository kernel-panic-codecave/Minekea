...
public class BlockTVWallTopMiddle extends Block
{
	public static final PropertyDirection FACING = PropertyDirection.create("facing");
	public static final PropertyBool ENABLED = PropertyBool.create("enabled");
	
	public BlockTVWallTopMiddle()
	{
		super(Material.IRON);
		setSoundType(SoundType.METAL);
		setHardness(5.0F);
		setResistance(10.0F);
		setUnlocalizedName(Minekea.MODID + ".blocktvwalltopmiddle");
		setRegistryName("blocktvwalltopmiddle");
