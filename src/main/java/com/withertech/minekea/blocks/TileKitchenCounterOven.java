...
public class TileKitchenCounterOven extends TileEntity implements ITickable
{
	...
	public void update() 
	{
		...
		{
			if (player.openContainer instanceof ContainerKitchenCounterOven && asm.currentState().equals("closed"))
			{
				asm.transition("opening");
				

			} else if (!(player.openContainer instanceof ContainerKitchenCounterOven) && asm.currentState().equals("open"))
			{
    ...
    public TileKitchenCounterOven() {
    	if (FMLCommonHandler.instance().getSide() == Side.CLIENT) 
    	{
            asm = Minekea.proxy.load(new ResourceLocation(Minekea.MODID, "asms/block/blockkitchencounteroven.json"), ImmutableMap.of());
    	} else
    	{
    		asm = null;
    	}
	...
	private ItemStackHandler inputHandler = new ItemStackHandler(INPUT_SLOTS) 
    {
        ...
        protected void onContentsChanged(int slot) 
        {
            ...
            TileKitchenCounterOven.this.markDirty();
        }
    };
