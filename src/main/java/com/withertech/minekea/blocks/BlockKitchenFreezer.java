...
public class BlockKitchenFreezer extends Block implements ITileEntityProvider
{
	public static final PropertyDirection FACING = PropertyDirection.create("facing");
	
	public BlockKitchenFreezer()
	{
		super(Material.ROCK);
		setSoundType(SoundType.STONE);
		setHardness(2.0F);
		setResistance(5.0F);
		setUnlocalizedName(Minekea.MODID + ".blockkitchenfreezer");
		setRegistryName("blockkitchenfreezer");
	...
	public void initModel()
	{
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileKitchenFreezer.class, new AnimationTESR<>());
	}
